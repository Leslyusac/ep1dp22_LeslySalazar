...
txt_valor1.pack(fill=tkinter.X, pady=4)


lbl_valor2=tkinter.Label(ventana, text="Nombre centro", bg="green", font=("Calibri",12))
lbl_valor2.pack()
txt_valor2=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor2.pack(fill=tkinter.X, pady=4)

lbl_valor3=tkinter.Label(ventana, text="Dirección centro", bg="green", font=("Calibri",12))
lbl_valor3.pack()
txt_valor3=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor3.pack(fill=tkinter.X, pady=4)


lbl_valor4=tkinter.Label(ventana, text="Teléfono centro", bg="green", font=("Calibri",12))
lbl_valor4.pack()
txt_valor4=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor4.pack(fill=tkinter.X, pady=4)


lbl_valor5=tkinter.Label(ventana, text="Director centro", bg="green", font=("Calibri",12))
lbl_valor5.pack()
txt_valor5=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor5.pack(fill=tkinter.X, pady=4)


lbl_valor6=tkinter.Label(ventana, text="Url centro", bg="green", font=("Calibri",12))
lbl_valor6.pack()
txt_valor6=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor6.pack(fill=tkinter.X, pady=4)



lbl_valor7=tkinter.Label(ventana, text="Fecha creación", bg="green", font=("Calibri",12))
lbl_valor7.pack()
txt_valor7=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor7.pack(fill=tkinter.X, pady=4)



lbl_valor8=tkinter.Label(ventana, text="Tipo centro", bg="green", font=("Calibri",12))
lbl_valor8.pack()
txt_valor8=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor8.pack(fill=tkinter.X, pady=4)


lbl_valor9=tkinter.Label(ventana, text="Descripción centro", bg="green", font=("Calibri",12))
lbl_valor9.pack()
txt_valor9=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor9.pack(fill=tkinter.X, pady=4)


lbl_valor10=tkinter.Label(ventana, text="Cantidad Hombres", bg="green", font=("Calibri",12))
lbl_valor10.pack()
txt_valor10=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor10.pack(fill=tkinter.X, pady=4)


lbl_valor11=tkinter.Label(ventana, text="Cantidad Mujeres", bg="green", font=("Calibri",12))
lbl_valor11.pack()
txt_valor11=tkinter.Entry(ventana,bg="pink", font="Calibri")
txt_valor11.pack(fill=tkinter.X, pady=4)


btn_promedio = tkinter.Button(ventana, text="Calcular promedio", command=cargarDatos)
btn_promedio.pack(fill=tkinter.X, pady=4)
